  ...
  return (
    <section className="w-full flex justify-center items-center py-10 md:py-20">
      <div className="w-full max-w-6xl flex justify-center items-center flex-col gap-6 px-1 md:px-0">
        <h1 className="font-hill2 text-2xl md:text-4xl font-medium text-hill-primary text-center">
        ...
        <div className="w-full flex flex-col md:flex-row  md:justify-between items-start gap-4 md:gap-10">
          ...
          <div className="w-full md:w-2/4 flex flex-col items-center md:items-start gap-10">
            <p className="font-hill leading-8 md:px-2 text-md text-center md:text-left">
          ...
          <div className="w-full md:w-1/4 flex flex-col items-center md:items-start">
            <h1 className="font-hill text-xl md:text-2xl text-hill-primary pb-4">
              Elérhetőségünk
            </h1>
            <div className="flex flex-col font-medium font-hill text-md gap-2 text-center md:text-left">
              <a
                href="#"
                target="_blank"
          ...
          <div className="w-full md:w-1/4 flex flex-col items-center md:items-start gap-6">
            <h1 className="font-hill text-xl md:text-2xl text-hill-primary ">
              Nyitvatartás
            </h1>
            <div className="w-full px-6 md:px-0 flex flex-col font-medium font-hill text-md">
