    ...
    >
      ...
      <div className="w-full flex flex-col md:flex-row md:gap-10 ">
        <div className="relative z-0 w-full mb-5 group">
          <input
            type="text"
            id="lastName"
            className={`font-semibold block py-2.5 px-3 w-full text-base md:text-md font-merrieweather border-b-2 bg-white/30  appearance-none focus:outline-none focus:ring-0 peer 
                ${
                  errors.lastName
          ...
          <label
            htmlFor="lastName"
            className="hidden absolute bottom-1/2 translate-y-1/2 text-base md:text-md left-3 font-merrieweather peer-focus:hidden peer-placeholder-shown:block text-gray-100"
          >
            Vezetéknév*
          </label>
          {errors.lastName && (
      ...
      <div className="relative w-full">
        <textarea
          id="msg"
          placeholder=" "
          className={`font-semibold px-3 py-1 h-24 w-full scroll-y-auto text-base md:text-md font-merrieweather border bg-white/30  appearance-none focus:outline-none focus:ring-0 peer 
            ${
              errors.firstName
                ? "border-b-red-500 focus:border-b-red-500"
                : "border-b-white focus:border-b-hill-secondary"
        ...
        <label
          htmlFor="msg"
          className="hidden absolute top-1 left-3 text-base md:text-md font-merrieweather peer-focus:hidden peer-placeholder-shown:block text-gray-100"
        >
          Az ön üzenete*
        </label>
        {errors.msg && (
